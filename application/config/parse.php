...
elseif( $_SERVER['HTTP_HOST'] == 'cctv-camera-videonabludenie.pp.ua' ){ #cctv-kiev.pp.ua => cctv-camera-videonabludenie.pp.ua
...
elseif( $_SERVER['HTTP_HOST'] == 'cctv-commax.pp.ua' ){ #cctv-domofon.pp.ua => cctv-commax.pp.ua
